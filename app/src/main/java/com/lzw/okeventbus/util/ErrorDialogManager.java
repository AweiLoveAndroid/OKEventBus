...
package com.lzw.okeventbus.util;

import com.lzw.okeventbus.OKEventBus;
...
public class ErrorDialogManager {
    ...
    public static class SupportManagerFragment extends Fragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            mOKEventBus = ErrorDialogManager.factory.config.getOKEventBus();
            mOKEventBus.register(this);
